...
$db = conectarDB();
  ...
  if (isset($_POST['adminBorrarJugador']) && isset($_POST['checks']))
  {
    ...
    {
        borrarManoJugador(23,$nJug,$db);
    } 
  }
  $vJugCartas = getJugadoresCartas(23,$db);
...
<body>
    ...
    <input type="hidden" name="seleccionPar" value="<?php echo 23?>"/>
    <h1>
      Clasificacion de la partida <?php echo getNombrePartida(23,$db).' ('.    Count($vJugCartas).' jugadores)';?>
    </h1>
...
function OnSubmitForm()
{
  ...
  {
    document.myform.action ="claTT.php";
  }
  return true;
}
</script>
