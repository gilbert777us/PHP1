<?php
   ...
   else
   {
    $tab = $_POST["tablero"];
    $fin = false;
    if ((strpos($tab, '*') !== false) || (strpos($tab, '.') !== false))
    {
      $fin = true;
    }
   }
...
else if (isset ($_POST["bI"]))
   {
     $_POST["tablero"] = transformarI($_POST["tablero"]);
   }
else if (isset ($_POST["bPt"]))
   {
     $_POST["tablero"] = transformarPt($_POST["tablero"]);
   }
  ...
  <fieldset>  
   ...
   <fieldset>  
    ...
    <input type="submit" name="bIz" value="<" />
     <input type="submit" name="bPt" value="." />
    <input type="submit" name="bUp" value="^" />
     <input type="submit" name="bI" value="I" />
